...
type CategoryServiceClient interface {
	...
	CreateCategory(ctx context.Context, in *CategoryCreateRequest, opts ...grpc.CallOption) (*CategoryResponse, error)
...
func (c *categoryServiceClient) CreateCategory(ctx context.Context, in *CategoryCreateRequest, opts ...grpc.CallOption) (*CategoryResponse, error) {
...
type CategoryService_CreateCategoryStreamClient interface {
	Send(*CategoryCreateRequest) error
...
func (x *categoryServiceCreateCategoryStreamClient) Send(m *CategoryCreateRequest) error {
...
func (x *categoryServiceCreateCategoryStreamBidirectionalClient) Send(m *CategoryCreateRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
type CategoryServiceServer interface {
	...
	CreateCategory(context.Context, *CategoryCreateRequest) (*CategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) CreateCategory(context.Context, *CategoryCreateRequest) (*CategoryResponse, error) {
...
func _CategoryService_CreateCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).CreateCategory(ctx, req.(*CategoryCreateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
type CategoryService_CreateCategoryStreamServer interface {
	...
	Recv() (*CategoryCreateRequest, error)
	grpc.ServerStream
}
...
func (x *categoryServiceCreateCategoryStreamServer) Recv() (*CategoryCreateRequest, error) {
	m := new(CategoryCreateRequest)
...
func (x *categoryServiceCreateCategoryStreamBidirectionalServer) Recv() (*CategoryCreateRequest, error) {
	m := new(CategoryCreateRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
